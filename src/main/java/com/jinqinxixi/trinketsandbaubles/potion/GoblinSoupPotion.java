...
public class GoblinSoupPotion extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level,
        ...
        tooltip.add(Component.translatable("item.trinketsandbaubles.goblin_soup.tooltip"));
        tooltip.add(Component.translatable("item.trinketsandbaubles.goblin_soup.tooltip1"));
    }
}