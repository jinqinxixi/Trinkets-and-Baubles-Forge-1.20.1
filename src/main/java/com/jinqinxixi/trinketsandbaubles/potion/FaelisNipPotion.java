...
public class FaelisNipPotion extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level,
        ...
        tooltip.add(Component.translatable("item.trinketsandbaubles.faelis_food.tooltip"));
        tooltip.add(Component.translatable("item.trinketsandbaubles.faelis_food.tooltip1"));
    }
}