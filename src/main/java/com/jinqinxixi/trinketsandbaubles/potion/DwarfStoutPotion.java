...
public class DwarfStoutPotion extends Item {
    static final int USE_DURATION = 32;    // 长按时间

    public DwarfStoutPotion() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level,
        ...
        tooltip.add(Component.translatable("item.trinketsandbaubles.dwarf_stout.tooltip"));
        tooltip.add(Component.translatable("item.trinketsandbaubles.dwarf_stout.tooltip1"));
    }
}
