...
public class FairyDewPotion extends Item {
    static final int USE_DURATION = 32;    // 长按时间

    public FairyDewPotion() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level,
        ...
        tooltip.add(Component.translatable("item.trinketsandbaubles.fairy_dew.tooltip"));
        tooltip.add(Component.translatable("item.trinketsandbaubles.fairy_dew.tooltip1"));
    }
}
